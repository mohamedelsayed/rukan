<div class="faqs index">
	...
	<tr>
			...
			<?php /*<th><?php echo $this->Paginator->sort('answer');?></th>*/?>
	...
	<tr<?php echo $class;?>>
		...
		<?php /*<td><?php echo $faq['Faq']['answer']; ?>&nbsp;</td>*/?>		
		<td><?php echo $faq['Faq']['approved']; ?>&nbsp;</td>
		<td><?php echo $faq['Faq']['weight']; ?>&nbsp;</td>
		<td><?php echo $faq['Faq']['created']; ?>&nbsp;</td>
		<td><?php echo $faq['Faq']['updated']; ?>&nbsp;</td>
		<td class="actions">
